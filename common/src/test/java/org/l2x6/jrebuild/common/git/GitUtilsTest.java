...
public class GitUtilsTest {
    ...
    void toNormalizedHttpsUri() {
        assertThat(GitUtils.toNormalizedHttpsUri("http://janino-compiler.github.io/janino/"))
                .isEqualTo("http://janino-compiler.github.io/janino");
        assertThat(GitUtils.toNormalizedHttpsUri("https://code.google.com/p/jsr-305/"))
                .isEqualTo("https://code.google.com/p/jsr-305");
