...
class GitScmLocatorTest {
    ...
    void lookupScmInfoRelaxNG() {
        TagInfo tag = GitScmLocator.builder().build().resolveTagInfo(Gav.of("relaxngDatatype:relaxngDatatype:20020414"));
    ...
    void lookupScmInfoCommonsLang() {
        TagInfo tag = GitScmLocator.builder().build().resolveTagInfo(Gav.of("commons-lang:commons-lang:2.5"));
        Assertions.assertNotNull(tag);
